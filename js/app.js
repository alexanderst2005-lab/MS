...
const crearTarjetaProductoHTML = (producto) => {
    ...
    const rutaImagen = (producto.imagenes && producto.imagenes[0]) ? producto.imagenes[0] : PLACEHOLDER_SVG;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Listener del buscador del Navbar (redirige a catálogo si es necesario)
